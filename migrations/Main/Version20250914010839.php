...
final class Version20250914010839 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE establishment (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, tenant_id BIGINT NOT NULL, address VARCHAR(255) NOT NULL, public_id VARCHAR(12) NOT NULL, UNIQUE INDEX UNIQ_DBEFB1EEB5B48B91 (public_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
